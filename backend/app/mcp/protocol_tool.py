...
class MCPTool(Tool):
    ...
    def _create_builtin_server(self):
        ...
        try:
            ...
            server = FastMCP("LpyAgents-BuiltinServer")
            ...
            def greet(name: str = "World") -> str:
                """友好问候"""
                return f"Hello, {name}! 欢迎使用 LpyAgents MCP 工具！"
            ...
            def get_system_info() -> dict:
                ...
                return {
                    ...
                    "server_name": "LpyAgents-BuiltinServer",
                    "tools_count": 6
                }
    ...
    def _discover_tools(self):
        """发现MCP服务器提供的所有工具"""
        try:
            from ..Client.MyMCPClient import MCPClient
            import asyncio
